...
import { B as renderTemplate, k as addAttribute, u as maybeRenderHead, C as spreadAttributes, J as unescapeHTML, x as renderComponent, y as renderHead, z as renderSlot } from './entrypoint_jb8Q-nvW.mjs';
...
const $$MainHead = createComponent(($$result, $$props, $$slots) => {
  ...
  const {
    title = "Rodrigo Camino: Desarrollador web",
    description = "3+ Años de experiencia en el desarrollo de la Web. Desarrollador web creativo."
  } = Astro2.props;
...
}, "/home/rodrigo-camino/web/portfolio/.claude/worktrees/agent-a403cdf31b466407d/src/components/es/MainHead.astro", void 0);
...
const iconPaths = {
  ...
  "globe": `<path d="M128,80a48,48,0,1,0,48,48A48.05,48.05,0,0,0,128,80Zm0,80a32,32,0,1,1,32-32A32,32,0,0,1,128,160ZM176,24H80A56.06,56.06,0,0,0,24,80v96a56.06,56.06,0,0,0,56,56h96a56.06,56.06,0,0,0,56-56V80A56.06,56.06,0,0,0,176,24Zm40,152a40,40,0,0,1-40,40H80a40,40,0,0,1-40-40V80A40,40,0,0,1,80,40h96a40,40,0,0,1,40,40ZM192,76a12,12,0,1,1-12-12A12,12,0,0,1,192,76Z">`
};
...
const $$Icon = createComponent(($$result, $$props, $$slots) => {
  ...
  return renderTemplate`${maybeRenderHead()}<svg xmlns="http://www.w3.org/2000/svg" width="40" height="40" viewBox="0 0 256 256" aria-hidden="true"${addAttribute(gradient ? `url(#${gradientId})` : color, "stroke")}${addAttribute(gradient ? `url(#${gradientId})` : color, "fill")}${spreadAttributes(attrs, void 0, { "class": "astro-ixvnic3r" })} data-astro-cid-ixvnic3r> <g data-astro-cid-ixvnic3r>${unescapeHTML(iconPath)}</g> ${gradient && renderTemplate`<linearGradient${addAttribute(gradientId, "id")} x1="23" x2="235" y1="43" y2="202" gradientUnits="userSpaceOnUse" data-astro-cid-ixvnic3r> <stop stop-color="var(--gradient-stop-1)" data-astro-cid-ixvnic3r></stop> <stop offset=".5" stop-color="var(--gradient-stop-2)" data-astro-cid-ixvnic3r></stop> <stop offset="1" stop-color="var(--gradient-stop-3)" data-astro-cid-ixvnic3r></stop> </linearGradient>`} </svg>`;
}, "/home/rodrigo-camino/web/portfolio/.claude/worktrees/agent-a403cdf31b466407d/src/components/es/Icon.astro", void 0);

const $$ThemeToggle = createComponent(($$result, $$props, $$slots) => {
  return renderTemplate`${renderComponent($$result, "theme-toggle", "theme-toggle", { "data-astro-cid-osvogh6n": true }, { "default": () => renderTemplate` ${maybeRenderHead()}<button data-astro-cid-osvogh6n> <span class="sr-only" data-astro-cid-osvogh6n>Tema oscúro</span> <span class="icon light" data-astro-cid-osvogh6n>${renderComponent($$result, "Icon", $$Icon, { "icon": "sun", "data-astro-cid-osvogh6n": true })}</span> <span class="icon dark" data-astro-cid-osvogh6n>${renderComponent($$result, "Icon", $$Icon, { "icon": "moon-stars", "data-astro-cid-osvogh6n": true })}</span> </button> ` })}  ${renderScript($$result, "/home/rodrigo-camino/web/portfolio/.claude/worktrees/agent-a403cdf31b466407d/src/components/es/ThemeToggle.astro?astro&type=script&index=0&lang.ts")}`;
}, "/home/rodrigo-camino/web/portfolio/.claude/worktrees/agent-a403cdf31b466407d/src/components/es/ThemeToggle.astro", void 0);
...
const $$Nav = createComponent(($$result, $$props, $$slots) => {
  ...
  return renderTemplate`${maybeRenderHead()}<nav data-astro-cid-wjouko2p> <div class="menu-header" data-astro-cid-wjouko2p> <a href="/" class="site-title" data-astro-cid-wjouko2p> ${renderComponent($$result, "Icon", $$Icon, { "icon": "terminal-window", "color": "var(--accent-regular)", "size": "1.6em", "gradient": true, "data-astro-cid-wjouko2p": true })}
Rodrigo Camino
</a> ${renderComponent($$result, "menu-button", "menu-button", { "data-astro-cid-wjouko2p": true }, { "default": () => renderTemplate` <template data-astro-cid-wjouko2p>${templateEnter()} <button class="menu-button" aria-expanded="false" data-astro-cid-wjouko2p> <span class="sr-only" data-astro-cid-wjouko2p>Menú</span> ${renderComponent($$result, "Icon", $$Icon, { "icon": "list", "data-astro-cid-wjouko2p": true })} </button> ${templateExit()}</template> ` })} </div> <noscript> <ul class="nav-items" data-astro-cid-wjouko2p> ${textLinks.map(({ label, href }) => renderTemplate`<li data-astro-cid-wjouko2p> <a${addAttribute(Astro2.url.pathname === href, "aria-current")}${addAttribute([
    "link",
    {
      active: Astro2.url.pathname === href || href !== "/es/" && Astro2.url.pathname.startsWith(href)
    }
  ], "class:list")}${addAttribute(href, "href")} data-astro-cid-wjouko2p> ${label} </a> </li>`)} </ul> </noscript> <noscript> <div class="menu-footer" data-astro-cid-wjouko2p> <div class="socials" data-astro-cid-wjouko2p> ${iconLinks.map(({ href, icon, label }) => renderTemplate`<a${addAttribute(href, "href")} class="social" data-astro-cid-wjouko2p> <span class="sr-only" data-astro-cid-wjouko2p>${label}</span> ${renderComponent($$result, "Icon", $$Icon, { "icon": icon, "data-astro-cid-wjouko2p": true })} </a>`)} </div> </div> </noscript> <div id="menu-content" hidden data-astro-cid-wjouko2p> <ul class="nav-items" data-astro-cid-wjouko2p> ${textLinks.map(({ label, href }) => renderTemplate`<li data-astro-cid-wjouko2p> <a${addAttribute(Astro2.url.pathname === href, "aria-current")}${addAttribute([
    "link",
    {
      active: Astro2.url.pathname === href || href !== "/es/" && Astro2.url.pathname.startsWith(href)
    }
  ], "class:list")}${addAttribute(href, "href")} data-astro-cid-wjouko2p> ${label} </a> </li>`)} </ul> <div class="menu-footer" data-astro-cid-wjouko2p> <div class="lang-toggle" data-astro-cid-wjouko2p> ${renderComponent($$result, "LangToggle", $$LangToggle, { "data-astro-cid-wjouko2p": true })} </div> <div class="socials" data-astro-cid-wjouko2p> ${iconLinks.map(({ href, icon, label }) => renderTemplate`<a${addAttribute(href, "href")} class="social" data-astro-cid-wjouko2p> <span class="sr-only" data-astro-cid-wjouko2p>${label}</span> ${renderComponent($$result, "Icon", $$Icon, { "icon": icon, "data-astro-cid-wjouko2p": true })} </a>`)} </div> <div class="theme-toggle" data-astro-cid-wjouko2p> ${renderComponent($$result, "ThemeToggle", $$ThemeToggle, { "data-astro-cid-wjouko2p": true })} </div> </div> </div> </nav> ${renderScript($$result, "/home/rodrigo-camino/web/portfolio/.claude/worktrees/agent-a403cdf31b466407d/src/components/es/Nav.astro?astro&type=script&index=0&lang.ts")}`;
}, "/home/rodrigo-camino/web/portfolio/.claude/worktrees/agent-a403cdf31b466407d/src/components/es/Nav.astro", void 0);

const $$Footer = createComponent(($$result, $$props, $$slots) => {
  const Astro2 = $$result.createAstro($$props, $$slots);
  Astro2.self = $$Footer;
  const currentYear = (/* @__PURE__ */ new Date()).getFullYear();
  return renderTemplate`${maybeRenderHead()}<footer data-astro-cid-jcqllswv> <div class="group" data-astro-cid-jcqllswv> <p class="credit" data-astro-cid-jcqllswv>
Diseñado y Desarrollado en Buenos Aires con <a href="https://astro.build/" data-astro-cid-jcqllswv>Astro</a> ${renderComponent($$result, "Icon", $$Icon, { "icon": "rocket-launch", "size": "1.2em", "data-astro-cid-jcqllswv": true })} </p> <p data-astro-cid-jcqllswv>&copy; ${currentYear} Rodrigo Camino</p> </div> <p class="socials" data-astro-cid-jcqllswv> <a href="https://x.com/RodrigoCamino8" data-astro-cid-jcqllswv> X </a> <a href="https://github.com/kirigaya97" data-astro-cid-jcqllswv> GitHub</a> <a href="https://instagram.com/rodri.camino" data-astro-cid-jcqllswv> Instagram</a> <a href="https://linkedin.com/in/rodrigo-camino" data-astro-cid-jcqllswv>LinkedIn</a> </p> </footer>`;
}, "/home/rodrigo-camino/web/portfolio/.claude/worktrees/agent-a403cdf31b466407d/src/components/es/Footer.astro", void 0);

const $$BaseLayout = createComponent(($$result, $$props, $$slots) => {
  const Astro2 = $$result.createAstro($$props, $$slots);
  Astro2.self = $$BaseLayout;
  const { title, description } = Astro2.props;
  return renderTemplate`<html lang="en" data-astro-cid-h54kgfv5> <head>${renderComponent($$result, "MainHead", $$MainHead, { "title": title, "description": description, "data-astro-cid-h54kgfv5": true })}${renderHead()}</head> <body data-astro-cid-h54kgfv5> <div class="stack backgrounds" data-astro-cid-h54kgfv5> ${renderComponent($$result, "Nav", $$Nav, { "data-astro-cid-h54kgfv5": true })} ${renderSlot($$result, $$slots["default"])} ${renderComponent($$result, "Footer", $$Footer, { "data-astro-cid-h54kgfv5": true })} </div> ${renderScript($$result, "/home/rodrigo-camino/web/portfolio/.claude/worktrees/agent-a403cdf31b466407d/src/layouts/es/BaseLayout.astro?astro&type=script&index=0&lang.ts")} </body> </html>`;
}, "/home/rodrigo-camino/web/portfolio/.claude/worktrees/agent-a403cdf31b466407d/src/layouts/es/BaseLayout.astro", void 0);

const $$CallToAction = createComponent(($$result, $$props, $$slots) => {
  const Astro2 = $$result.createAstro($$props, $$slots);
  Astro2.self = $$CallToAction;
  const { href } = Astro2.props;
  return renderTemplate`${maybeRenderHead()}<a${addAttribute(href, "href")} data-astro-cid-vxn2n2dh>${renderSlot($$result, $$slots["default"])}</a>`;
}, "/home/rodrigo-camino/web/portfolio/.claude/worktrees/agent-a403cdf31b466407d/src/components/es/CallToAction.astro", void 0);

const $$ContactCTA = createComponent(($$result, $$props, $$slots) => {
  return renderTemplate`${maybeRenderHead()}<aside data-astro-cid-kfayzohv> <h2 data-astro-cid-kfayzohv>Querés que trabajemos juntos?</h2> ${renderComponent($$result, "CallToAction", $$CallToAction, { "href": "https://wa.me/+5491132125484", "data-astro-cid-kfayzohv": true }, { "default": ($$result2) => renderTemplate`
Enviame un mensaje
${renderComponent($$result2, "Icon", $$Icon, { "icon": "whatsapp", "size": "1.2em", "data-astro-cid-kfayzohv": true })} ` })} </aside>`;
}, "/home/rodrigo-camino/web/portfolio/.claude/worktrees/agent-a403cdf31b466407d/src/components/es/ContactCTA.astro", void 0);

const $$Hero = createComponent(($$result, $$props, $$slots) => {
  const Astro2 = $$result.createAstro($$props, $$slots);
  Astro2.self = $$Hero;
  const { align = "center", tagline, title } = Astro2.props;
  return renderTemplate`${maybeRenderHead()}<div${addAttribute(["hero stack gap-4", align], "class:list")} data-astro-cid-bbfxsvzz> <div class="stack gap-2" data-astro-cid-bbfxsvzz> <h1 class="title" data-astro-cid-bbfxsvzz>${title}</h1> ${tagline && renderTemplate`<p class="tagline" data-astro-cid-bbfxsvzz>${tagline}</p>`} </div> ${renderSlot($$result, $$slots["default"])} </div>`;
}, "/home/rodrigo-camino/web/portfolio/.claude/worktrees/agent-a403cdf31b466407d/src/components/es/Hero.astro", void 0);

export { $$BaseLayout as $, $$CallToAction as a, $$ContactCTA as b, $$Hero as c, $$Icon as d };
