import { p as generateCspDigest, C as spreadAttributes, J as unescapeHTML, B as renderTemplate, w as removeBase, s as isRemotePath, K as unflatten, v as object, n as date, l as array, A as AstroError, U as UnknownContentCollectionError, D as string } from './entrypoint_jb8Q-nvW.mjs';
...
class ImmutableDataStore {
  ...
  static async fromModule() {
    try {
      const data = await import('./_astro_data-layer-content_BbsH8HYd.mjs');
