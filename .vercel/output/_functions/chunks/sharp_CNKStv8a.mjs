import { A as AstroError, j as UnsupportedImageFormat, h as MissingSharp } from './entrypoint_jb8Q-nvW.mjs';
import { b as baseService, d as detector, p as parseQuality } from './generic_CwTVMSvJ.mjs';
...
async function loadSharp() {
  let sharpImport;
  try {
    sharpImport = (await import('./index_CmLUG7XT.mjs').then(n => n.i)).default;
  } catch {
