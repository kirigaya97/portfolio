...
technologies:
  - name: WordPress
    note: Gestión de contenido que permite actualizaciones sencillas.
  - name: DIVI Builder
    note: Diseño modular personalizado que resalta servicios y testimonios.
  - name: HTML/CSS/JS Personalizados
    note: Elementos interactivos que mejoran la UX sin afectar los tiempos de carga.
screenshots:
  - /assets/michel/1.png
  - /assets/michel/2.png
  - /assets/michel/3.png
