...
technologies:
  - name: WordPress
    note: Facilita las actualizaciones del cliente y la gestión de contenido.
  - name: DIVI
    note: Modularidad y capacidades nativas de SEO.
  - name: PHP, JavaScript, HTML, CSS
    note: Funcionalidades personalizadas, estilos y optimización de interactividad sin plugins adicionales.
screenshots:
  - /assets/capfa/1.png
  - /assets/capfa/2.png
  - /assets/capfa/3.png
