...
technologies:
  - name: WordPress
    note: Gestión de contenido eficiente con actualizaciones fáciles.
  - name: DIVI Builder
    note: Diseño modular y layout personalizable para mejorar la participación.
  - name: HTML/CSS/JavaScript
    note: Código personalizado para elementos interactivos con mínima carga de plugins.
screenshots:
  - /assets/santi/2.webp
  - /assets/santi/3.webp
  - /assets/santi/4.webp
