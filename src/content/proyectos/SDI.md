...
technologies:
  - name: WordPress
    note: Gestión de contenido eficiente y actualizaciones fáciles para el cliente.
  - name: DIVI Builder
    note: Personalización de diseño modular y flexible.
  - name: Código Personalizado (HTML/CSS/JS)
    note: Elementos únicos de UI/UX para una experiencia de usuario cohesiva y profesional.
screenshots:
  - /assets/SDI/1.png
  - /assets/SDI/2.png
  - /assets/SDI/3.png
