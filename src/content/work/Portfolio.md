...
technologies:
  - name: Astro
    note: Static site generation with excellent performance.
  - name: Tailwind CSS
    note: Rapid, flexible styling adjustments.
  - name: HTML & JavaScript
    note: Dynamic elements enhancing interactivity without slowing performance.
screenshots:
